TEMPLATE_STRINGS = {
    ...
    'manage_user':{
        ...
        'form_label_username':'User\'s e-mail address.',
        'form_label_password':'User\'s password.',
        ...
        'form_error_password':'The user\'s password must be letters and numbers only and at least six characters long.',
